  ...
  const analyses = [
    {
      ...
      badgeColor: "text-[#00F0FF] bg-[#00F0FF]/15 border-[#00F0FF]/25"
    },
    {
      slug: "defense",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <div>
            <Link
              ...
              className="group inline-flex items-center gap-2 font-mono text-[11px] tracking-wider text-[#00F0FF] hover:text-white transition-colors duration-300"
            >
          ...
          {analyses.map((cs, idx) => (
            ...
            >
              <Link
                ...
                className="group relative h-full flex flex-col justify-between p-8 rounded-[18px] bg-[#04040c]/90 border border-white/5 hover:border-[#00F0FF]/30 transition-all duration-500 shadow-lg"
              >
                <div>
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <BookOpen className="w-4 h-4 text-white/20 group-hover:text-[#00F0FF]/40 transition-colors duration-300" />
                  </div>

                  <h3 className="text-2xl font-sans font-extrabold text-white tracking-tight group-hover:text-[#00F0FF] transition-colors duration-300">
                    {cs.title}
                  </h3>
                ...
                <div className="mt-12 pt-4 border-t border-white/5 flex items-center justify-between font-mono text-[10px] text-white/40 group-hover:text-white transition-colors duration-300">
                  ...
                  <ArrowRight className="w-3.5 h-3.5 transition-transform group-hover:translate-x-1 group-hover:text-[#00F0FF]" />
                </div>
              </Link>
            </motion.div>
          ))}
